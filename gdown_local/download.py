...
def download(
    ...
    if output_is_path and os.path.isdir(output): # output.endswith(osp.sep):
    ...
    if output_is_path:
        ...
        if resume and existing_tmp_files:
            ...
            resume = False
            # the following line was modified vs the original code (tmp_file_fd was added)
    ...
    try:
        ...
        if not quiet:
            pbar.close()
        if tmp_file:
            os.close(tmp_file_fd)  # the line was added vs the original code
            f.close()
